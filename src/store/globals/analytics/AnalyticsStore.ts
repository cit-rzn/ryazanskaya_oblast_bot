...
import { EErrorType } from '../error/types.ts';
import { IRootStore } from '../root/declarations.ts';

import { MyTrackerAdapter, YandexMetrikaAdapter } from './adapters';
import { IAnalyticsAdapter } from './adapters/types.ts';
import { EAnalyticsEvent } from './config.ts';
import { IAnalyticsStore } from './declaration.ts';
import { TAnalyticsPage } from './types.ts';
